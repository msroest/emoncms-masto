...
plt.FigureBackground.Color = new Color(51, 51, 51);
plt.DataBackground.Color = new Color(51, 51, 51);
plt.Axes.Color(Color.FromHex("#FFFFFF"));
plt.Grid.MajorLineColor = Color.FromHex("#FFFFFF");
